...
CREATE TRIGGER update_hallmarking_updated_at BEFORE UPDATE ON hallmarking FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
CREATE TRIGGER update_loyalty_updated_at BEFORE UPDATE ON loyalty FOR EACH ROW EXECUTE FUNCTION update_updated_at_column(); 